...
function relayStylePagination(keyArgs) {
    ...
    return {
        ...
        read: function (existing, _a) {
            ...
            return tslib.__assign(tslib.__assign({}, existing), { edges: edges, pageInfo: tslib.__assign(tslib.__assign({}, existing.pageInfo), { startCursor: (_b = edges[0]) === null || _b === void 0 ? void 0 : _b.cursor, endCursor: (_c = edges[edges.length - 1]) === null || _c === void 0 ? void 0 : _c.cursor }) });
        },
        merge: function (existing, incoming, _a) {
            var _b, _c;
            if (existing === void 0) { existing = makeEmptyData(); }
            ...
            var pageInfo = tslib.__assign(tslib.__assign(tslib.__assign({}, incoming.pageInfo), existing.pageInfo), { startCursor: (_b = edges[0]) === null || _b === void 0 ? void 0 : _b.cursor, endCursor: (_c = edges[edges.length - 1]) === null || _c === void 0 ? void 0 : _c.cursor });
