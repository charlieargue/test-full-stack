...
var ApolloProvider = function (_a) {
    ...
    return React__default.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(context.client, 8) : tsInvariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
function useApolloClient() {
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(client, 7) : tsInvariant.invariant(client, 'No Apollo Client instance can be found. Please ensure that you ' +
